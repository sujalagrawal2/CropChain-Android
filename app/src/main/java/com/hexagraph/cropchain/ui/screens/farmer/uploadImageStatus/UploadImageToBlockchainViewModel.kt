...
//    val cropList: List<CropImages> = emptyList(),
//    val progress: Int = 0
//)
//
...
//                    cropRepository.updateCropImage(crop)
//                }
//            }
//            workManager.count()
//        }
...
//    fun getAllCrops() {
//        viewModelScope.launch {
//            cropRepository.getAllCropImagesInDescendingOrder().collect { cropList ->
...
//                            cropRepository.updateCropImage(it)
//                        }
